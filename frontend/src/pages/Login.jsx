    ...
    <div className="min-h-screen bg-[#1e1f29] text-[#f8f8f2] font-sans flex flex-col items-center pt-12 px-4 selection:bg-[#44475a]">
      ...
      <div className="bg-[#282a36]/40 border border-[#44475a] w-full max-w-[400px] rounded-xl p-8 shadow-2xl backdrop-blur-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button 
            type="submit" 
            className="w-full bg-[#ff79c6] hover:bg-[#ff92d0] text-[#1e1f29] font-bold py-3 px-4 rounded-lg shadow-lg hover:shadow-[#ff79c6]/20 transition duration-200 text-sm tracking-wide transform active:scale-[0.99] outline-none"
          >
            Sign In
          </button>
        </form>
        ...
        <div className="mt-8 text-center border-t border-[#44475a] pt-4">
          <p className="text-xs text-[#f8f8f2]/60">
            Need an account? <span onClick={() => navigate('/register')} className="text-[#ff79c6] hover:underline cursor-pointer font-medium ml-1">Reg.</span>
          </p>
        </div>
      </div>
    </div>
